...
struct UIHelper {
    ...
    static func colorForDifficulty(difficulty: Int) -> UIColor {
        switch difficulty {
        case 1: return UIColor(red: 0.6, green: 1.0, blue: 0.6, alpha: 1.0) // Light green
        case 2: return UIColor(red: 0.8, green: 1.0, blue: 0.4, alpha: 1.0) // Yellowish-green
        case 3: return UIColor(red: 1.0, green: 0.8, blue: 0.4, alpha: 1.0) // Light orange
        case 4: return UIColor(red: 1.0, green: 0.4, blue: 0.2, alpha: 1.0) // Red-orange
        case 5: return UIColor(red: 1.0, green: 0.2, blue: 0.2, alpha: 1.0) // Light red
        default: return UIColor(red: 0.8, green: 0.8, blue: 0.8, alpha: 1.0) // Light gray
        }
    }
}
...
extension UITextField {
    /// Set left padding for a text field
...
extension CAGradientLayer {
    /// Convert gradient layer to an image
